...
The recovered architectural views can be shared between users allowing collaborative architecture recovery.
\end{abstract}
...
The following sections will detail each of the three steps.
