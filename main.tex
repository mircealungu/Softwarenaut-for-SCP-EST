...
\item The {\em Detail} panel presents particular facts about the entity selected in the Exploration panel. The goal is to supplement the information about the element selected in the exploration panel. The detail panel implements the ``details-on-demand'' part of Shneiderman's visualization mantra \cite{shneid-eyes}.
