...
\title{Softwarenaut:\\ A Tool for Software Architecture Recovery}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.9\linewidth]{SnautWorkflow}
...
% with a more lightweight model. Their model is advantageous since they benefit from more fine-grained information about the evolution; the disadvantage is that the animation of all the commits is time consuming. They do not support a query mechanism for visualizing only special types of relations.
