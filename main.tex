...
\item {\bf Dynamic-based}. These take into account the dynamics of the relationships across versions. {\em Stable relationships} do not change much during the evolution of the system, {\em Instable relationships} changed much during the history of the system.
\end{itemize}
...
\chg{}{find better examples here maybe}
...
\caption{Architectural Views are stored in the Global View Repository. This enables knowledge \chg{transfer}{beter!}}
\flabel{}
\end{center}
\end{figure}
